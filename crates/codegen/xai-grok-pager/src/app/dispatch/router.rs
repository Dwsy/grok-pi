...
set_max_thoughts_width, set_multiline_mode, set_page_flip_on_send, set_progress_bar,
    ...
    set_scroll_speed, set_session_recap, set_show_thinking_blocks, set_show_tips,
